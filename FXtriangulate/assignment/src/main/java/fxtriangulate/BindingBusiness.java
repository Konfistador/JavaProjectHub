...
class BindingBusiness {
     ...
     * @return the area value as DoubleBinding
     * @see <a href="https://en.wikipedia.org/wiki/Triangle">...</a>
     */
    final DoubleBinding areaBinding(DoubleBinding lengthA, DoubleBinding lengthB,
        ...
        DoubleBinding areaBinding = new DoubleBinding() {
            ...
            protected double computeValue() {
                ...
                var a = lengthA.getValue();
                var b = lengthB.getValue();
                var c = lengthC.getValue();
//
//                double semiPerimeter = (a + b + c) / 2;
//
//                System.out.println("PEDAL");
//                System.out.println("semiPerimeter = " + semiPerimeter);
//                System.out.println("lengthA = " + lengthA.getValue());
//                System.out.println("lengthB = " + lengthB.getValue());
//                System.out.println("lengthC = " + lengthC.getValue());
    ...
    DoubleBinding lengthBinding(
        ...
        DoubleBinding lengthBinding = new DoubleBinding() {
            ...
            protected double computeValue() {
                ...
                var endx = endX.getValue();
                var startx = startX.getValue();
                var endy = endY.getValue();
                var starty = startY.getValue();

                return Math.sqrt((endx - startx) * (endx - startx)
