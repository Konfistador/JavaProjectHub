...
public class GumballStateTest {
    ...
    public void t1verifyStateTransition(
        ...
        var initialState = StateEnum.valueOf(initialStateName);
        ...
        switch(triggerName) {
            case "draw": initialState.draw(ctx);break;
            case "ejectCoin": initialState.ejectCoin(ctx);break;
            case "insertCoin": initialState.insertCoin(ctx);break;
            case "refill": initialState.refill(ctx,addBallsCount);break;
        }
    ...
    public void t4assertMessage(
        ...
        var returnable = new Gumball("RED");
    when(ctx.dispense()).thenReturn(returnable);
    assertThat(ctx.dispense().toString()).contains(returnable.toString());
